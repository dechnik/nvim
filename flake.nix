{
  description = "Dechnik Neovim distribution";
  inputs =
    # let
  ...
  outputs = {
  ...
  } @ inputs:
    {
      overlay = final: prev: let
        ...
        neovim-dechnik-luaconfig = pkgs.stdenv.mkDerivation rec {
          name = "neovim-dechnik-luaconfig";
      ...
      in {
        ...
        neovim-dechnik = pkgs.neovim.override {
          viAlias = true;
          vimAlias = true;
          withNodeJs = false;

          configure = {
            packages.dechnik = with pkgs.vimPlugins; {
              start =
                [
            ...
            customRC = ''
              set runtimepath^=${neovim-dechnik-luaconfig}
              luafile ${neovim-dechnik-luaconfig}/init.lua
            '';
          };
        };
      };
    ...
    // flake-utils.lib.eachDefaultSystem (
      ...
      in rec {
        packages = with pkgs; {
          inherit neovim-dechnik;

          default = neovim-dechnik;
        };
